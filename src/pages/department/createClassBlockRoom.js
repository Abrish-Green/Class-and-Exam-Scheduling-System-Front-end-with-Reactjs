...
const ClassRoomAssigner = ()=>{
    ...
    const GetAddedRooms = async ()=>{
        ...
        await axios({
            method: 'post',
            url: '/department/get/selected/block/room',
            data: {
    ...
    const AddRooms = async (year)=>{
        ...
        await axios({
            method: 'post',
            url: '/department/add/class/block/room',
            data: {
                'department_id': department_id, 
                'room' : tempRoom,
                'block' : tempBlock,
...
export default ClassRoomAssigner