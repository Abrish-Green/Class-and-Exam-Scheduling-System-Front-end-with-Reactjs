...
const CreateInstructor = () => {
    ...
    const CreateInstructors = async (e) =>{
        e.preventDefault()
        setdepartmentNameError('')
        setdepartmentHeadError('')
        ...
        if(Validate(e)){
           ...
           const response1 = await axios({
                method: 'post',
                url: '/department/create-instructor',
                data: {
                    'name' : departmentName,
            ...
            const response2 = await axios({
                    method: 'post',
                    url: '/department/create-instructor-email',
                    data: {
                        'email': departmentHead,
                    }
                  });
                ...
                { success && <Success message="Successfully Created. Email Has been sent to Department Head. " />}
                   ...
                   {loading && <Sending message="Sending..."/>}
                        <div className="form-group row">
                            ...
                            <p style={{ marginLeft:'1em' }}>Instructor Name</p>
                        ...
                        <div className="form-group row">
                            ...
                            <p style={{ marginLeft:'1em' }}>Instructor Email</p> 
                          <br />
                            <div className="col-9 col-lg-12">
                            ...
                            <div className="col-sm-6 pl-0" style={{ marginTop: '1em' }}>
                                <p className="text-right">
                                    <button type="submit" onClick={(e)=>CreateInstructors(e)} className="btn btn-space btn-primary">Submit</button>
